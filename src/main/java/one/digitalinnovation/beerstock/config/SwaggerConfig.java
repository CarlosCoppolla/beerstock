...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Carlos Coutinho";
    private static final String CONTACT_GITHUB = "https://github.com/CarlosCoppolla";
    private static final String CONTACT_EMAIL = "carloscoppolla@gmail.com";
